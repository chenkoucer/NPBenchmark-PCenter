...
#ifndef SMART_JQ_PCENTER_CSV_READER_H
#define SMART_JQ_PCENTER_CSV_READER_H
...
#define SMART_JQ_PCENTER_CSV_READER_RECURSIVE_VERSION  0
...
public:
    ...
    const std::vector<Row>& scan(std::ostringstream &oss) {
        ...
        #if SMART_JQ_PCENTER_CSV_READER_RECURSIVE_VERSION
        onNewLine(begin);
        #else
        onNewLine_opt(begin);
        #endif // SMART_JQ_PCENTER_CSV_READER_RECURSIVE_VERSION
...
#endif // SMART_JQ_PCENTER_CSV_READER_H
